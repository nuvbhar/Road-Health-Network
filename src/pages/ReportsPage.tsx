...
export const ReportsPage: React.FC = () => {
  ...
  const displayedReports = filteredAndSorted.slice(
    (page - 1) * pageSize,
    page * pageSize,
  );
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontSize: "var(--type-heading)", fontWeight: 600 }}>
        ...
        {displayedReports.length === 0 ? (
          ...
          displayedReports.map((report) => (
            <ReportRow
              key={report.id}
              report={report}
              onClick={(r) => setSelectedReportId(r.id)}
            />
          ))
        )}
      </div>
      ...
      >
        ...
        >
          ...
          {filteredAndSorted.length} reports
        </div>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "4px",
              border: "1px solid var(--border-default)",
              background: page === 1 ? "var(--bg-inset)" : "white",
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "4px",
              border: "1px solid var(--border-default)",
              background: page === totalPages ? "var(--bg-inset)" : "white",
